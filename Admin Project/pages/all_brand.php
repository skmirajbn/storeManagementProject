...
<div class="pagination">
  <a href="pages/all_brand.php?page=1">&laquo;</a>
  <a href="pages/all_brand.php?page=<?=$currentPage-1?>">&lt;</a>
  <?php 
                if($currentPage>2){
                  $page = $currentPage - 2;
                ...
                for($page; $page<=$lastPage; $page++){ 
                  ?>
  <a href="pages/all_brand.php?page=<?=$page?>" class="<?=$currentPage == $page ? 'active' : '' ?>"><?=$page?></a>
  <?php } ?>
  <a href="pages/all_brand.php?page=<?=$currentPage + 1?>">&gt;</a>
